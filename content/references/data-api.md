...
## Get Ledger
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/getLedger.js "Source")
...
## Get Transaction
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/getTransactions.js "Source")
...
## Get Payments
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/getPayments.js "Source")
...
## Get Exchanges
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/getExchanges.js "Source")
...
## Get Exchange Rates
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/getExchangeRate.js "Source")
...
## Normalize
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/normalize.js "Source")
...
## Get Daily Reports
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/reports.js "Source")
...
## Get Stats
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/stats.js "Source")
...
|:---------|:-----------------|:--------|
| `type`   | All XDV Ledger [transaction types](transaction-formats.html), including `Payment`, `AccountSet`, `OfferCreate`, and others. | Number of transactions of the given type that occurred during the interval. |
...
## Get Active Accounts
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/activeAccounts.js "Source")
...
## Get Exchange Volume
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getMetric.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/externalMarkets.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/xdvDistribution.js "Source")
...
[Try it! >](data-api-v2-tool.html#get-xdv-distribution)
...
## Get Top Currencies
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/topCurrencies.js "Source")
...
## Get Top Markets
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/topMarkets.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getFees.js "Source")
...
## Get Fee Stats
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getFeeStats.js "Source")

Returns snapshots of the metrics derived from `divvyd`'s [`fee` command](fee.html). _(New in [v2.3.2][])_
...
## Get Topology
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getTopology.js "Source")
...
## Get Topology Nodes
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getNodes.js "Source")
...
## Get Topology Links
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getLinks.js "Source")
...
## Get Validator
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getValidators.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getManifests.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getValidatorReports.js "Source")
...
## Get divvyd Versions
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/network/getVersions.js "Source")
...
[Try it! >](data-api-v2-tool.html#get-divvyd-versions)
...
## Get All Gateways
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/gateways.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/gateways.js#L199 "Source")
...
## Get Accounts
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accounts.js "Source")
...
## Get Account
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/getAccount.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountBalances.js "Source")
...
## Get Account Orders
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountOrders.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountTransactions.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountTxSeq.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountPayments.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountExchanges.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountBalanceChanges.js "Source")
...
## Get Account Reports
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountReports.js "Source")
...
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/accountStats.js "Source")
...
## Health Check - API
[[Source]<br>](https://github.com/xdv/divvyd-historical-database/blob/master/api/routes/checkHealth.js "Source")
...
In the Data API, a Payment Object represents an event where one account sent value to another account. This mostly lines up with XDV Ledger transactions of the `Payment` [transaction type](transaction-types.html), except that the Data API does not consider a transaction to be a payment if the sending `Account` and the `Destination` account are the same, or if the transaction failed.
...
| `destination_tag`             | Integer                    | (May be omitted) A [destination tag](become-an-xdv-ledger-gateway.html#source-and-destination-tags) specified in this payment. |
| `source_tag`                  | Integer                    | (May be omitted) A [source tag](become-an-xdv-ledger-gateway.html#source-and-destination-tags) specified in this payment. |
...
| `port`             | Integer                         | (May be omitted) Port where this server speaks the [`divvyd` Peer Protocol](peer-protocol.html). |
...
Reports, stats, and aggregated exchange data needs more processing before the API can make it available. This processing uses Apache Storm as well as some custom scripts. See [Storm Setup](https://github.com/xdv/divvyd-historical-database/blob/master/storm/README.md) for more information.
