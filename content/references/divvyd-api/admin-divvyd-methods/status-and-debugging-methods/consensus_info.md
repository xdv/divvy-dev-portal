# consensus_info
[[Source]<br>](https://github.com/xdv/divvyd/blob/a61ffab3f9010d8accfaa98aa3cacc7d38e74121/src/divvy/rpc/handlers/ConsensusInfo.cpp "Source")

The `consensus_info` command provides information about the consensus process for debugging purposes.

_The `consensus_info` method is an [admin method](admin-divvyd-methods.html) that cannot be run by unprivileged users._
