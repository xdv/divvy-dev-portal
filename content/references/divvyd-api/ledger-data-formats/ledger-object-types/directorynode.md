# DirectoryNode
[[Source]<br>](https://github.com/xdv/divvyd/blob/5d2d88209f1732a0f8d592012094e345cbe3e675/src/divvy/protocol/impl/LedgerFormats.cpp#L44 "Source")
...
* **Owner directories** list other objects owned by an account, such as `DivvyState` or `Offer` objects.
...
The lower 64 bits of an Offer Directory's ID represent the TakerPays amount divided by TakerGets amount from the offer(s) in that directory as a 64-bit number in the XDV Ledger's internal amount format.
