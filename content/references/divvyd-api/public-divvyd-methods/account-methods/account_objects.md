# account_objects
[[Source]<br>](https://github.com/xdv/divvyd/blob/399c43cae6e90a428e9ce6a988123972b0f03c99/src/divvy/rpc/handlers/AccountObjects.cpp "Source")
...
- [DivvyState objects](divvystate.html) for trust lines where this account's side is not in the default state.
...
- [DepositPreauth objects](depositpreauth-object.html) for deposit preauthorizations. [New in: divvyd 1.1.0][]
...
divvyd account_objects r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59 validated
```
...
| `type`         | String                                     | _(Optional)_ If included, filter results to include only this type of ledger object. The valid types are: `check`, `deposit_preauth`, `escrow`, `offer`, `payment_channel`, `signer_list`, and `state` (trust line). <!-- Author's note: Omitted types from this list that can't be owned by an account, and ticket until Tickets are enabled: https://github.com/xdv/divvyd/blob/1dbc5a57e6b0e90a9da0d6e56f2f5a99e6ac1d8c/src/divvy/rpc/impl/RPCHelpers.cpp#L676-L686 --> |
