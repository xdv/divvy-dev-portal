# account_tx
[[Source]<br>](https://github.com/xdv/divvyd/blob/master/src/divvy/rpc/handlers/AccountTx.cpp "Source")
...
divvyd -- account_tx r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59 -1 -1 2 5 1 0 1
```
...
[[Source]<br>](https://github.com/xdv/divvyd/blob/master/src/divvy/rpc/handlers/AccountTxSwitch.cpp "Source")<br>
...
* `actBitcoin` - The [Address][] specified in the `account` field is formatted like a Bitcoin address instead of a XDV Ledger address.
