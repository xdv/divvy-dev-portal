...
| `ledger.close_time`            | Integer | The time this ledger was closed, in [seconds since the Divvy Epoch][] |
...
| `ledger.total_coins`           | String  | Total number of XDV drops in the network, as a quoted integer. (This decreases as transaction costs destroy XDV.) |
...
<!-- TODO: we should add this fee levels link to divvyd-api-links.md. server_state.md is also including this as a one-off.-->
