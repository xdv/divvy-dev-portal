# sign_for
[[Source]<br>](https://github.com/xdv/divvyd/blob/release/src/divvy/rpc/handlers/SignFor.cpp "Source")
...
This command requires the [MultiSign amendment](known-amendments.html#multisign) to be enabled. [New in: divvyd 0.31.0][]
...
```
#Syntax: divvyd sign_for <signer_address> <signer_secret> [offline]
divvyd sign_for rsA2LpzuawewSBQXkiju3YQTMzW13pAAdW s████████████████████████████ '{
    "TransactionType": "TrustSet",
    "Account": "rEuLyBCvcw4CFmzv8RepSiAoNgF8tTGJQC",
    "Flags": 262144,
    "LimitAmount": {
