# tx
[[Source]<br>](https://github.com/xdv/divvyd/blob/master/src/divvy/rpc/handlers/Tx.cpp "Source")
...
divvyd tx E08D6E9754025BA2534A78707605E0601F03ACE063687A0CA1BDDACFCD1698C7 false
```
...
* `txnNotFound` - Either the transaction does not exist, or it was part of an older ledger version that `divvyd` does not have available.
