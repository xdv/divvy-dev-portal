# DepositPreauth
[[Source]<br>](https://github.com/xdv/divvyd/blob/master/src/divvy/app/tx/impl/DepositPreauth.cpp "Source") <!--{# TODO: change from develop to master when 1.1.0 is released #}-->
...
|:--------------|:----------|:------------------|:-----|
| `Authorize`   | String    | AccountID         | _(Optional)_ The XDV Ledger address of the sender to preauthorize. |
| `Unauthorize` | String    | AccountID         | _(Optional)_ The XDV Ledger address of a sender whose preauthorization should be revoked. |
