...
Here's an example transaction ready to be multi-signed:

    {
        ...
        "Account": "dEuLyBCvcw4CFmzv8RepSiAoNgF8tTGJQC",
        "Flags": 262144,
        "LimitAmount": {
            "currency": "USD",
            "issuer": "dHb9CJAWyB4dj91VRWn96DkukG4bwdtyTh",
            "value": "100"
        },
        "Sequence": 2,
        "SigningPubKey": "",
...
<!--{#_ #}-->
    ...
    $ divvyd sign_for rsA2LpzuawewSBQXkiju3YQTMzW13pAAdW <rsA2L..'s secret> '{
    >     "TransactionType": "TrustSet",
...
<!--{#_ #}-->
    ...
    $ divvyd sign_for rUpy3eEg8rqjqfUoLeBnZkscbKbFsKXC3v <rUpy..'s secret> '{
    >    "Account" : "rEuLyBCvcw4CFmzv8RepSiAoNgF8tTGJQC",
    >    "Fee" : "30000",
    >    "Flags" : 262144,
    >    "LimitAmount" : {
...
In stand-alone mode, the server automatically considers a ledger to be `validated` if it has been manually closed.
    ...
    $ divvyd tx BD636194C48FD7A100DE4C972336534C8E710FD008C0F3CF7BC5BF34DAF3C3E6
    Loading: "/home/mduo13/.config/divvy/divvyd.cfg"
    Connecting to 127.0.0.1:5005
    {
    	"result": {
